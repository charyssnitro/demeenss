...
module.exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ['802964705752514561', '802964707736289320', '802964721691000832', '802964722398789692', '802964755245039666'].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
    return
 ...
 if(!kullanıcı) {
    ...
    .setDescription(`<a:hell_thisr:801795242348118068> Toplam Kayıtlar:  \`${kayıtlar}\`
    <a:gul4_karagul:800221909303689256> Toplam Erkek Kayıtların: \`${erkek}\`
    <a:gul3_krmzglKopya:800221910239543336> Toplam Kadın Kayıtların: \`${kadın}\`
    `)
...
.setAuthor(`${kullanıcı.username}`)
    .setDescription(`<a:hell_thisr:801795242348118068> Toplam Kayıtlar:  \`${kayıtlar1}\`
    <a:gul4_karagul:800221909303689256> Toplam Erkek Kayıtların: \`${erkek1}\`
    <a:gul3_krmzglKopya:800221910239543336> Toplam Kadın Kayıtların: \`${kadin1}\`
    `)
