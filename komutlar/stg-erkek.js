...
genelchat.send(`<a:gul4_karagul:800221909303689256> <@${member.id}>, Aramıza Hoş Geldin \n\nTagımızı Alarak Ailemize Katılabilirsin <a:kalp:782707004887662643>`)
  
const embed = new Discord.MessageEmbed()
.setAuthor(message.guild.name, message.guild.iconURL({ dynamic: true }))
.setDescription(`<a:gul4_karagul:800221909303689256> • ${member} üyesi ${message.author} Tarafından ${erkek} olarak kayıt edildi.`) 
.setColor("0x2f3136")
...
.addField(`<a:deneme_tik:791115828493811780> Roller`, `${erkek}`, true)
